const hobos = [
    ...
    `Black Bolt, King of the Inhumansillustration`,
    `Strictly Local Henry Bobtail`,
    `Manny the High-Ranking Mason`,
    `Fry-Pan Jim Fry`,
    `Slo-Mo Deuteronomy`,
    `Half-Bearded Mark`,
    `Knee-Brace Kennyillustration`,
    `Morris the Personal Trainer`,
    `Thundertwine`,
    `Cleats Onionpocket`,
    `Deformed Abeillustration`,
    ...
    `Dora the Explorer`,
    `Ms. Mary Manx, the Tailless Catillustration`,
    `Free-Peanuts Dougillustration`,
    `Steve the Human Tunneler`,
    `Redball Charlie Dickens`,
    `Twink the Reading-Room Snoozer`,
    `Microfiche Roy, the Side-Scroller`,
    `McGurk, Who May Be Found by the Card Catalogueillustration`,
    `Booster D'Souza`,
    `Commodore Sixty-Four`,
    `Moped Enid, the Mopedist`,
    `Lamant the Junkmanillustration`,
    `Fast-Neck Nell`,
    ...
    `Venomous Byron`,
    `Five-Chambered-Stomach Mort St. Johnillustration`,
    `Gravybelly Dunstan`,
    `Extra-Skin Dave`,
    `Beanbag-Chair Bill`,
    ...
    `Douglas, the Future of Hoboing 0 `,
    `Ironbelly Norton`,
    `Dilly Shinguards`,
    `Rufus Caboose`,
    ...
    `Jiminy Sinner`,
    `Pamela Chickeneggs (i.e., Hobo Caviar)`,
    ...
    `Mad or Sad Judd (no one can tell)`,
    ...
    `Kevin Eggsandbacon`,
    `Ol' Johnny One-Joke`,
    `Tramp Trampson (not a tramp, but a renowned hobo trampolinist)`,
    ...
    `nasdijj`,
    `You know what? I'm going to go ahead and keep Nick Nolte.`
  ];

export default hobos;
